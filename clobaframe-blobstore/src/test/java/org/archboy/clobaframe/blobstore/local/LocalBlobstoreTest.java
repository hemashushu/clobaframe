...
//	@Inject
	...
	private static final String DEFAULT_TEST_BUCKET_NAME = "test-clobaframe-bucket";

	//@Value("${test.blobstore.bucketName}")
	private String testBucketName = DEFAULT_TEST_BUCKET_NAME;
	...
	public void testCreateBucket() throws IOException {
		...
		// delete exist first
		if (blobstore.exist(testBucketName)){

			BlobResourceRepository repository = blobstore.getRepository(testBucketName);
			...
			// delete bucket.
			blobstore.delete(testBucketName);
			assertFalse(blobstore.exist(testBucketName));
			return;
		}

		// test make
		blobstore.create(testBucketName);

		// test exist
		assertTrue(blobstore.exist(testBucketName));
...
//
//		// check bucket first
//		if (!blobstore.existBucket(testBucketName)){
//			blobstore.createBucket(testBucketName);
//		}
//
//		// clean first
//		cleanByKey(key1);
...
//		cleanByKey(key3);
//
//		BlobKey blobKey1 = new BlobKey(testBucketName, key1);
//
//		// test put blob
...
//		BlobKey blobKeyNoneExists = new BlobKey(testBucketName, "noneExists");
//		try{
...
//		blobstore.delete(new BlobKey(testBucketName, "noneExists"));
//
...
//		}
//
//		BlobKey prefixAll = new BlobKey(testBucketName, null);
//
//		// delete exist blobs
...
//
//		// test put blob
//		writeContent(blobstore, new BlobKey(testBucketName, "a"), "a");
//		writeContent(blobstore, new BlobKey(testBucketName, "r-j001"), "j001");
//		writeContent(blobstore, new BlobKey(testBucketName, "r-j002"), "j002");
//		writeContent(blobstore, new BlobKey(testBucketName, "r-c-c001"), "c001");
//		writeContent(blobstore, new BlobKey(testBucketName, "r"), "r");
//
//		// test list
...
//
//		BlobResourceInfoPartialCollection blobsByPrefix1 = blobstore.list(new BlobKey(testBucketName, "r-"));
...
//
//		BlobResourceInfoPartialCollection blobsByPrefix2 = blobstore.list(new BlobKey(testBucketName, "r-c-"));
...
//		BlobKey blobKey = new BlobKey(testBucketName, key);
//		try{
