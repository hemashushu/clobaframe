 ...
 * @author young
 */
public class ImageComposite implements Composite{
	...
	public ImageComposite(Image image, int xOffset, int yOffset, float opacity) {
		this.image = image;
	...
	public BufferedImage composite(BufferedImage bufferedImage) {
		...
		BufferedImage compositeImage = ((AbstractImage)image).getBufferedImage();
