 ...
 * @author yang
 */
public class NamedTextResourceInfo extends AbstractNamedResourceInfo implements ContentHashResourceInfo, TextResourceInfo {
	...
	public NamedTextResourceInfo(String name, String text, Charset charset, String mimeType, Date lastModified) {
		Assert.hasText(name);
		Assert.hasText(text);
	...
	public NamedTextResourceInfo(String name, String mimeType, String text){
