package org.archboy.clobaframe.resource.http;
...
public class NamedResourceSenderTest {
	...
	public void setUp() throws Exception {
		...
		ServletHolder servletHolder1 = new ServletHolder(
				new TestingWebResourceSenderServlet(namedResourceSender));
	...
	public void testSend() throws FileNotFoundException {
		...
		NamedResourceInfo webResource1 = resourceManager.getServedResource("test.png");
	...
	private void assertResponseContentEquals(CloseableHttpClient client, HttpGet method, NamedResourceInfo resourceInfo) throws IOException {
	...
	public static class TestingWebResourceSenderServlet extends HttpServlet {
		...
		private NamedResourceSender webResourceSender;

		public TestingWebResourceSenderServlet(NamedResourceSender webResourceSender) {
