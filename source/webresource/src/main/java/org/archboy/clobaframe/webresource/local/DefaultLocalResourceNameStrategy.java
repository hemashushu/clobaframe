...
import org.archboy.clobaframe.webresource.local.LocalResourceNameStrategy;
 ...
 * @author yang
 */
public class DefaultLocalResourceNameStrategy extends DefaultLocalFileNameStrategy implements LocalResourceNameStrategy {
	...
	public DefaultLocalResourceNameStrategy(File basePath, String namePrefix) {
		super(basePath);
