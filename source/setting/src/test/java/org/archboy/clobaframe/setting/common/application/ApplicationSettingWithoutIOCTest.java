 ...
 * @author yang
 */
public class ApplicationSettingWithoutIOCTest {

	private final Logger logger = LoggerFactory.getLogger(ApplicationSettingWithoutIOCTest.class);
	...
	public void setUp() throws Exception {
		...
		ApplicationSettingImpl appSetting = new ApplicationSettingImpl();
